...
notation of Natural Deduction. There are four groups of judgement rules: for {\bf types}, {\bf terms} and {\bf definitional equalities} on both.
Rules in each group can be in turn classified into
{\bf formations}, {\bf introductions}, {\bf eliminators} and {\bf computational rules}.
...
\bibitem{sojakova} Kristina Sojakova \textit{Higher Inductive Types as Homotopy-Initial Algebras} 2015
\bibitem{alvaro} Alvaro Pelayo, Michael A. Warren \textit{Homotopy type theory} 2014
